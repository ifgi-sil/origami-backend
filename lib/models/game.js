...
gameSchema.set('toJSON', {
  ...
  transform: function transform (doc, ret) {
    const { _id, name, description, type, timecompl, difficulty, waypoints } = ret;

    return { _id, name, description, type, timecompl, difficulty, waypoints };
  }
});
...
gameSchema.statics.addPlayer = function addPlayer (params) {
  return this
    .findOne({ _id: params.gameId })
    .exec()
    .then(function (game) {
      ...
      game.players.addToSet(params._id);
