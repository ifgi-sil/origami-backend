...
const checkPlayerGamePrivilage = function checkPlayerGamePrivilage (req, res, next) {
  if (req.params.gameId) {
    try {
      req._user.checkPlayerGamePrivilage(req.params.gameId);
